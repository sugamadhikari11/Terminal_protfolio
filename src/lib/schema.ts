    ...
    "@graph": [
      {
        ...
        url: `${SITE_URL}/`,
        name: "Sugam Adhikari (SA) | Full-Stack, Web3 & Data Science Portfolio",
        description:
          "Sugam Adhikari (SA) — full-stack developer in Kathmandu, Nepal. Portfolio of Next.js, Web3, Solidity, and data science projects.",
        isPartOf: websiteRef(),
        about: personRef(),
    ...
    "@graph": [
      {
        ...
        name: "About Sugam Adhikari (SA)",
        description:
          "Learn about Sugam Adhikari (SA) — a full-stack and Web3 developer based in Kathmandu, Nepal.",
        isPartOf: websiteRef(),
    ...
    "@graph": [
      {
        ...
        name: "Projects | Sugam Adhikari (SA)",
        isPartOf: websiteRef(),
        about: personRef(),
        inLanguage: IN_LANGUAGE,
  ...
  return {
    ...
    "@graph": [
      ...
      },
      {
        ...
        url: projectUrl,
        name: `${project.name} — Project | Sugam Adhikari (SA)`,
        isPartOf: websiteRef(),
  ...
  return {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "@id": `${postUrl}#webpage`,
        url: postUrl,
        name: `${post.title} | Sugam Adhikari (SA)`,
        isPartOf: websiteRef(),
        inLanguage: IN_LANGUAGE,
      },
      breadcrumbList([
    ...
    "@graph": [
      {
        ...
        name: "References | Sugam Adhikari (SA)",
        description:
